...
import { postSchema, reactionSchema } from '../schema/post';
...
module.exports = {
  ...
  async getPost(req, res) {
    ...
    async updatePost(req, res) {
        ...
        let result = await postService.updatePost(req.body, id);
  ...
  async deletePost(req, res) {
    ...
    async getAllLikes(req, res) {
        ...
        const data = await postService.getAllLikes({ post_id: mongoose.Types.ObjectId(req.params.id) })
    ...
    async addLike(req, res) {
        ...
        const [isLiked, postExist] = await Promise.all([
            postService.getOneData(postReactionModel, {user_id: req.decoded._id, post_id: mongoose.Types.ObjectId(req.params.id) } ),
            postService.getOneData(postModel, { _id: mongoose.Types.ObjectId(req.params.id) } )
        ]) ;
